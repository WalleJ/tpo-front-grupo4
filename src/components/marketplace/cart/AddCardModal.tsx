...
export function AddCardModal({ isOpen, onClose, onAdd }: Readonly<AddCardModalProps>) {
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} title="Add New Card" subtitle="Payment method" maxWidthClass="max-w-md">
