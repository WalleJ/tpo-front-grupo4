...
export function ProfileHeader({ profile, showAdminButton, onAdminDashboard, onEditProfile, onLogout }: Readonly<ProfileHeaderProps>) {
    ...
    <section className="mb-lg">
      <div className="flex flex-col md:flex-row items-center md:items-end gap-md">
        ...
        <div className="text-center md:text-left flex-1">
          ...
          <p className="font-body-md text-on-surface-variant inline-flex items-center gap-xs">
