...
function getInitialEditData(profileDisplayName, profileData) {
...
function ProfilePage() {
  ...
  const confirmProfileModal = useModal();
  const {
    profile,
    selectedOrder,
    buyerLevel,
  ...
  return <><main className="pt-28 pb-16 px-gutter max-w-[1280px] mx-auto"><ProfileHeader
    profile={profile}
  ...
  /><div className="grid grid-cols-1 md:grid-cols-12 gap-md"><BuyerLevelCard monthly={buyerLevel.monthly} percent={buyerLevel.percent} /><LoginSessionsCard sessions={profile.loginSessions} /><PaymentMethodsCard methods={profile.paymentMethods} onDeleteRequest={(index) => deletePaymentModal.open(index)} /><SupportClaimsCard claims={profile.supportClaims} /><PurchaseHistoryTable
